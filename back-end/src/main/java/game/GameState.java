...
public class GameState {
    ...
    public static GameState forGame(Game game) {
        ...
        String winnerStr=(winner==null) ? null :(winner ==Player.PLAYER0 ?"X":"O");
        String currentPlayer=(game.getPlayer()==Player.PLAYER0)? "X":"O";
        return new GameState(cells,currentPlayer,winnerStr);
    }
    ...
    public String toString() {
        return """
                ...
                """.formatted(Arrays.toString(this.cells),this.currentPlayer,this.winner==null ?"null":"\"" +this.winner+"\"");
    }
