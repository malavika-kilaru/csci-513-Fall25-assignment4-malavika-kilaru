...
class App extends React.Component<Props, GameState> {
  ...
  newGame = async () => {
    ...
    this.setState({ cells: json['cells'],currentPlayer:json['currentPlayer']||'X',winner:json['winner']||null});
  }
  undo=async()=> {
    ...
    if(response.ok) {
      const json=await response.json();
      this.setState({
        cells:json['cells'],currentPlayer:json['currentPlayer']||'X',winner:json['winner']||null
      });
    }
